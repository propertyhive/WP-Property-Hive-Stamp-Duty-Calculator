...
= 1.0.27 =
* Corrected JS errors with Wales, Scotland and Commercial calculators
...
= 1.0.23 =
* Security update ensuring attributes in templates are escaped accordingly
* Declared support for WordPress 6.7.1

= 1.0.22 =
* Updated additional home rates by 2% following Autumn budget
* Declared support for WordPress 6.7
